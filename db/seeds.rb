...
Notification.create(title: "Parto" , description: "Mimosa encontra-se próximo a data do parto, fique atento aos sinais, um parto não deve demorar mais de 4 horas, se preceber qualquer alteração ou complicação procure ajuda do médico veterianio, a saúde dos seus animais depende de você", limit: limit)
Notification.create(title: "Cio" , description: "Bilasa encontra-se próximo a data do cio, fique atento aos sinais", limit: limit)
Notification.create(title: "Desverminação" , description: "Pequena precisa ser deverminada.", limit: limit)
Notification.create(title: "Mocha" , description: "Laranja precisa ser desverminada", limit: limit)
Notification.create(title: "Parto" , description: "Mimosa encontra-se próximo a data do parto, fique atento aos sinais, um parto não deve demorar mais de 4 horas, se preceber qualquer alteração ou complicação procure ajuda do médico veterianio, a saúde dos seus animais depende de você", limit: limit)
Notification.create(title: "Cio" , description: "Bilasa encontra-se próximo a data do cio, fique atento aos sinais", limit: limit)
Notification.create(title: "Desverminação" , description: "Pequena precisa ser deverminada.", limit: limit)
Notification.create(title: "Mocha" , description: "Laranja precisa ser desverminada", limit: limit)
