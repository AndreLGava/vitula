...
RSpec.describe ReproductionsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Reproduction. As you add validations to Reproduction, be sure to
  ...
  # ReproductionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all reproductions as @reproductions" do
      reproduction = Reproduction.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:reproductions)).to eq([reproduction])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new reproduction as @reproduction" do
