...
RSpec.describe ModulosController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all modulos as @modulos" do
      ...
      expect(assigns(:modulos)).to eq([modulo])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested modulo as @modulo" do
      ...
      expect(assigns(:modulo)).to eq(modulo)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new modulo as @modulo" do
      ...
      expect(assigns(:modulo)).to be_a_new(Modulo)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created modulo as @modulo" do
        post :create, {:modulo => valid_attributes}, valid_session
        expect(assigns(:modulo)).to be_a(Modulo)
        expect(assigns(:modulo)).to be_persisted
      end

      it "redirects to the created modulo" do
        post :create, {:modulo => valid_attributes}, valid_session
        expect(response).to redirect_to(Modulo.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved modulo as @modulo" do
        post :create, {:modulo => invalid_attributes}, valid_session
        expect(assigns(:modulo)).to be_a_new(Modulo)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested modulo" do
        modulo = Modulo.create! valid_attributes
        put :update, {:id => modulo.to_param, :modulo => new_attributes}, valid_session
        modulo.reload
      ...
      it "redirects to the modulo" do
        modulo = Modulo.create! valid_attributes
        put :update, {:id => modulo.to_param, :modulo => valid_attributes}, valid_session
        expect(response).to redirect_to(modulo)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the modulo as @modulo" do
        modulo = Modulo.create! valid_attributes
        put :update, {:id => modulo.to_param, :modulo => invalid_attributes}, valid_session
        expect(assigns(:modulo)).to eq(modulo)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the modulos list" do
      modulo = Modulo.create! valid_attributes
      delete :destroy, {:id => modulo.to_param}, valid_session
      expect(response).to redirect_to(modulos_url)
    end
  end
